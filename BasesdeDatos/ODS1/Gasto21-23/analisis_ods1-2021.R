...
tb_funcional_cons <-read.delim("BasesdeDatos/ODS1/Liquidaciones2021/tb_funcional_cons.txt", sep = ";", dec = ",", header = FALSE)
tb_inventario <-read.delim("BasesdeDatos/ODS1/Liquidaciones2021/tb_inventario.txt", sep = ";", dec = ",", header = FALSE)
...
desp21 <- tb_funcional_cons |> 
    inner_join(tb_inventario, by= c('Id'='Idente')) %>% 
    mutate(anyo= '2021')

writexl::write_xlsx(desp21, 'BasesdeDatos/ODS1/Gasto21-23/desp23-2021.xlsx', col_names= TRUE)

...
tb_funcional_cons <-read.delim("BasesdeDatos/ODS1/Liquidaciones2022/tb_funcional_cons.txt", sep = ";", dec = ",", header = FALSE)
tb_inventario <-read.delim("BasesdeDatos/ODS1/Liquidaciones2022/tb_inventario.txt", sep = ";", dec = ",", header = FALSE)
...
desp22 <- tb_funcional_cons %>% 
    inner_join(tb_inventario, by= c('Id'='Idente')) %>% 
    mutate(anyo= '2022')

writexl::write_xlsx(desp22, 'BasesdeDatos/ODS1/Gasto21-23/desp23-2022.xlsx', col_names= TRUE)

# prova22 <- read_xlsx("BasesdeDatos/ODS1/Gasto21-23/desp23-2022.xlsx")

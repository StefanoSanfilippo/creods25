...
tb_funcional_cons <-read.delim("./BasesdeDatos/ODS1/Liquidaciones2021/tb_funcional_cons.txt",
    sep = ";", dec = ",", header = FALSE)
tb_inventario <-read.delim(
    "./BasesdeDatos/ODS1/Liquidaciones2021/tb_inventario.txt",
    sep = ";", dec = ",", header = FALSE)
...
writexl::write_xlsx(desp32, 'BasesdeDatos/ODS4/desp32-2021.xlsx')
